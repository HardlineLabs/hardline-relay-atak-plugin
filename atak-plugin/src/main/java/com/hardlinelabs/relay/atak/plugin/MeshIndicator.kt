...
internal class MeshIndicator(private val map: MapView, open: () -> Unit) {
    ...
    private val badge =
        TextWidget("HL", MapView.getTextFormat(Typeface.DEFAULT_BOLD, 1), true).apply {
    ...
    private fun position() {
        ...
        badge.setPoint(
            x.coerceIn(
                0f,
                (map.width - badge.getSize(true, true)[0] - 24 * density).coerceAtLeast(0f),
            ),
